...
- **E-4 실검증 + 대사 한도 정리** — PR #36 (`test/reconciliation-duplicate-run`, 2026-08-22)
...
### 현재 상태
- **작업 브랜치:** `main` (**법적 맥락 조사 → 취소 기한 개정 완료. 어필 체크리스트 11개 전부 확보 = 계획된 작업 종결**)
- **마지막 main 커밋:** `Merge pull request #35` (908a6bc)
  - PR #1–11, #13–35 머지 완료
...
> 남은 것은 전부 선택 항목이다 — E-4(검토 결과 가치 낮음), F-1 CD("시간 여유 시"), 인프라 의존 실측.
...
6. **F-1 CD**(AWS EC2 배포) — CI는 #12로 완료, 배포는 미착수. 마스터플랜상 "시간 여유 시".
