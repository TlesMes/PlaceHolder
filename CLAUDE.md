...
- **무료/유료 포인트 재원 분리 (게임식 3계층)** — `feature/point-bucket-separation` (**작업 중 2026-08-19**, ADR-020)
  ...
  - ⚠️ **미완:** 브라우저 E2E 미실시. `EVENT` 만료·역방향 대사는 후속
...
1. ~~**무료/유료 포인트 구분**~~ → **구현 완료, 브라우저 E2E만 남음** (`feature/point-bucket-separation`, ADR-020). 3계층(EVENT/FREE/PAID)으로 구멍 봉쇄, 테스트 180 통과. 남은 것: E2E 검증 → PR.
