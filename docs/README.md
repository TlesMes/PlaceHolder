...
**언제:** Phase F에서 정리
**내용:**
- 핵심 기술 포인트 요약 → **루트 [README](../README.md)의 "핵심 작업"·"기술적 초점"으로 통합됨**
- 개선 전후 비교 (Phase D 수치 기반)

**중심:** 프로젝트를 처음 보는 사람이 읽을 **요약 문서**

> ⚠️ **서사 정리는 이 저장소 범위 밖으로 이동했다.** 여러 프로젝트를 함께 놓고
> 어떤 축을 어디서 보여줄지 배분하는 문제라, 통합 포트폴리오 작성 단계에서 다룬다.
> 재료(ADR 20종·측정 문서·README 핵심 작업 5절)는 이미 저장소에 남아 있다.
